...
RSpec.describe AddressBook do 
  ...
  context ".import_from_csv" do 
   ...
   #Test that AddressBook`s .import_from_csv(entries_2.csv) method is working as expected
    ...
    it "imports the 1st entry" do
      ...
      #Check the first entry
      entry_one = book.entries[0]
      check_entry(entry_one, "David", "999-789-0978", "david@noobz.com")   
    end
    it "imports the 2nd entry" do
      book.import_from_csv("entries_2.csv")
      #Check the second entry
      entry_two = book.entries[1]
      check_entry(entry_two, "Levi", "777-890-0998", "levi@rulez.com")
    end
    it "imports the 3rd entry" do
       book.import_from_csv("entries_2.csv")
       # Check the third entry
       entry_three = book.entries[2]
       check_entry(entry_three, "r2d2", "456-786-0354", "r2d2@nubian.com")
    end
  end
